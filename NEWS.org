#+title: marginalia.el - News
#+author: Omar Antolín Camarena, Daniel Mendler
#+language: en

* Version 2.12 (2026-08-21)

- Documentation updates only and minor code cleanup.
...
* Version 2.9 (2026-01-25)

- Add ~marginalia-annotate-frame~ for ~select-by-frame-name~ and ~select-frame-by-id~.
