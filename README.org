...
dependency this way. The =annotation-function= is documented in the [[https://www.gnu.org/software/emacs/manual/html_node/elisp/Completion.html][Elisp manual]].
...
=marginalia-hypothetical.el= package is a good idea, since Marginalia provides the
