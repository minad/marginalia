    ...
    (marginalia--fields
     ...
     ((cond
       ...
       (t (pcase (symbol-value sym)
            ...
            ((and (pred symbolp) (pred functionp) val) (propertize (concat "#'" (symbol-name val)) 'face 'marginalia-function))
            ((and (pred symbolp) val) (propertize (concat "'" (symbol-name val)) 'face 'marginalia-symbol))
